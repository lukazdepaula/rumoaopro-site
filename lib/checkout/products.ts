...
export const checkoutProducts: CheckoutProduct[] = [
  ...
  },
  {
    ...
    slug: "power-pro",
    description:
      "Programa de 12 semanas, 100% academia, para desenvolver força, potência, hipertrofia e um físico atlético com uma progressão clara.",
    language: "Portuguese",
    type: "training_program",
    ...fixedBrlProductPrice(39.9, 199),
    active: true,
    sales_page_path: "/programas/power-pro",
    cover_image: "/assets/programs/power-pro/power-pro-cover-v2.png",
    delivery_type: "member_area",
    file_id: null,
